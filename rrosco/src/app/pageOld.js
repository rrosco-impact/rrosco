...
import { ArrowDown, ArrowDownToLine, FileText } from "lucide-react";
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center">
      ...
      <section className="h-screen w-full flex justify-center items-center bg-[#EBE9DD] relative">
        ...
        <span className="flex flex-row absolute bottom-20 space-x-[12px]">
          <a
            href="https://www.linkedin.com/in/rrosco/"
            className="h-[48px] px-[12px] flex justify-center items-center bg-white border-[4px] border-[#0061EE] text-[#0061EE] rounded-[100px] space-x-[4px]"
          >
          ...
          <a
            href="https://www.linkedin.com/in/rrosco/"
            className="h-[48px] px-[12px] flex justify-center items-center bg-white border-[4px] border-[#FF77B9] text-[#FF77B9] rounded-[100px] space-x-[4px]"
          >
            <FileText className="h-[24px] w-[24px] text-[#FF77B9]" strokeWidth={2} />
            <span>Resume</span>
          </a>
        </span>
      </section>
